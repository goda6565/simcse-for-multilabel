...
from l2v.models.sscl import SimCSEModel
from l2v.utils.l2v import setup_l2v
import argparse
import wandb

wandb.init(project="simcse-l2v", name="sscl")
...
wandb.init(project="simcse-l2v", name=f"sscl-{args.dataset_name}")
...
sscl_model = SimCSEModel(model=model)
...
print(type(sscl_model).__name__)
...
sscl_model.decoder.save_pretrained(decoder_path)
