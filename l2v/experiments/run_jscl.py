...
from l2v.models.jscl import SimCSEModel
...
wandb.init(project=args.dataset_name, name=f"l2v-jscl batch size: {args.per_device_batch_size}")
...
jscl_model = SimCSEModel(model=model)
...
print(type(jscl_model).__name__)
...
jscl_model.decoder.save_pretrained(decoder_path)
