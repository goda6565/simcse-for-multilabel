...
from train_configs.bert.dscl import training_args
...
wandb.init(project="simcse-bert", name="dscl")
...
dscl_model = SimCSEModel(model, mlp_only_train=True)
...
# エンコーダを保存
encoder_path = "outputs/bert/dscl/encoder"
dscl_model.encoder.save_pretrained(encoder_path)
