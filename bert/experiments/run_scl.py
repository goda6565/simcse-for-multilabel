...
from train_configs.bert.scl import training_args
from utils.metrics import compute_metrics
from bert.utils.collates import eval_collate_fn, sup_scl_train_collate_fn
from bert.models.scl import SimCSEModel
from bert.utils.bert import setup_bert
import wandb

wandb.init(project="simcse-bert", name="scl")
...
scl_model = SimCSEModel(model, mlp_only_train=True)
...
trainer = SimCSETrainer(
    model=scl_model,
    args=training_args,
    data_collator=sup_scl_train_collate_fn,
...
# エンコーダを保存
encoder_path = "outputs/bert/scl/encoder"
scl_model.encoder.save_pretrained(encoder_path)
